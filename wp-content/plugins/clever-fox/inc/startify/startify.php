...
if ( ! function_exists( 'cleverfox_startify_frontpage_sections' ) ) :
	function cleverfox_startify_frontpage_sections() {	
		require CLEVERFOX_PLUGIN_DIR . 'inc/startify/sections/section-slider.php';
	...
	add_action( 'startkit_sections', 'cleverfox_startify_frontpage_sections' );
endif;

function cleverfox_startify_enqueue_scripts() {
	...
	wp_enqueue_script( 'owl-carousel', CLEVERFOX_PLUGIN_URL . 'inc/startify/js/owl.carousel.min.js', array('jquery'), false, true);
}
add_action( 'wp_enqueue_scripts', 'cleverfox_startify_enqueue_scripts' );
